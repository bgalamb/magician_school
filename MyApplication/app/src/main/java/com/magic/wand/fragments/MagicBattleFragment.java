 ...
 */
public class MagicBattleFragment extends Fragment implements SensorEventListener {
    private static final String TAG = "MyMagicBattle";
    private MagicBattleFragment.OnBattleFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof MagicBattleFragment.OnBattleFragmentInteractionListener) {
            mListener = (MagicBattleFragment.OnBattleFragmentInteractionListener) context;
        } else {
    ...
    protected void initSpeechRecognizer() {
        ...
        mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int i) {
                ...
                hearedword.setText("I don't understand!");
                //cleanup
                cleanUp();
            }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (matches != null && matches.size() > 0) {
                    ...
                    if (result) {
                        int power = LocalJsonLoader.getMagicPower(magicWord);
                        earnedPoints.setText("+"+power+"p");
                        mListener.onMagicInteraction(power);
                    }else{
    ...
    protected static boolean isMagicSuccessful(String magicWord, double[] measuredMovement, String axis) {
        ...
        for (int i = 0; i < numberOfTries; i++) {
            ...
            int value = Levenstein.numbericDistance2(
                    ...
                    EPSILON + (MainActivity.selectedMagicWand * 0.1) );

            Log.i(TAG, "difference of magic word compared to expected is " + value);
            Log.i(TAG, "===========");

            if (value < MAX_DIFFERENCE + (MainActivity.selectedMagicWand * 1) ) {
                return true;
            }
        }
        return false;
